        ...
        <div class="pesquisa">
                ...
                <b-row>
                    ...
                    <b-col md="6">
                        <b-form-group label="Médico" label-for="agenda-medico">
                            <b-form-input input type="text" id="agenda-medico" v-model="agendamento.agenda" readonly  class="mb-4 "></b-form-input>
                        </b-form-group>
                    </b-col>
                        <b-col md="4">
                        <b-button variant="primary" class="mt-4 ml-2 mr-4" size="lg" router-link to="/novoagendamento">Novo</b-button>
            ...
            <b-row>
                <b-col md="2">
                    <template>
                        <div>
                            <label for="example-datepicker">Escolha a Data</label>
